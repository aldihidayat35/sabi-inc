...
<body>
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="card login-card p-4" style="width: 100%; max-width: 410px;">
            ...
            <h2 class="text-center mb-4 fw-bold" style="letter-spacing:0.5px; color:#b08968;">Teacher Login</h2>
            ...
            <div class="text-center mt-3">
                <a href="{{ route('student.login') }}" class="text-decoration-none">Login sebagai Siswa</a>
            </div>
        </div>
    </div>
