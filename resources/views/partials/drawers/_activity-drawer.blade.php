		...
		<div class="card-header" id="kt_activities_header">
			...
			<div class="card-toolbar">
				<button type="button" class="btn btn-sm btn-icon btn-active-light-primary me-n5" id="kt_activities_close">
					<i class="ki-solid ki-cross fs-1"></i>				</button>
			</div>
		</div>
		<!--end::Header-->
		<!--begin::Body-->
...
<div class="timeline-item">
    ...
    <div class="timeline-icon">
        <i class="ki-solid ki-message-text-2 fs-2 text-gray-500"></i>    </div>
    <!--end::Timeline icon-->
...
<div class="timeline-item">
    ...
    <div class="timeline-icon me-4">
        <i class="ki-solid ki-flag fs-2 text-gray-500"></i>    </div>
    <!--end::Timeline icon-->
    <!--begin::Timeline content-->
...
<div class="timeline-item">
    ...
    <!--begin::Timeline icon-->
    <div class="timeline-icon">
        <i class="ki-solid ki-disconnect fs-2 text-gray-500"></i>    </div>
    <!--end::Timeline icon-->
    <!--begin::Timeline content-->
    <div class="timeline-content mb-10 mt-n1">
        <!--begin::Timeline heading-->
...
<div class="timeline-item">
    ...
    <!--begin::Timeline icon-->
    <div class="timeline-icon">
        <i class="ki-solid ki-abstract-26 fs-2 text-gray-500"></i>    </div>
    <!--end::Timeline icon-->
        <!--begin::Timeline content-->
    <div class="timeline-content mb-10 mt-n1">
        <!--begin::Timeline heading-->
...
<div class="timeline-item">
    ...
    <!--begin::Timeline icon-->
    <div class="timeline-icon">
        <i class="ki-solid ki-pencil fs-2 text-gray-500"></i>    </div>
    <!--end::Timeline icon-->
    <!--begin::Timeline content-->
    <div class="timeline-content mb-10 mt-n1">
        <!--begin::Timeline heading-->
...
<div class="timeline-item">
    ...
    <!--begin::Timeline icon-->
    <div class="timeline-icon">
        <i class="ki-solid ki-sms fs-2 text-gray-500"></i>    </div>
    <!--end::Timeline icon-->
    <!--begin::Timeline content-->
    <div class="timeline-content mb-10 mt-n1">
        <!--begin::Timeline heading-->
...
<div class="timeline-item">
    ...
    <!--begin::Timeline icon-->
    <div class="timeline-icon">
        <i class="ki-solid ki-basket fs-2 text-gray-500"></i>    </div>
    <!--end::Timeline icon-->
    <!--begin::Timeline content-->
...
<!--end::Timeline item-->
		...
		<div class="card-footer py-5 text-center" id="kt_activities_footer">
			<a href="?page=pages/user-profile/activity" class="btn btn-bg-body text-primary">
				View All Activities <i class="ki-solid ki-arrow-right fs-3 text-primary"></i>			</a>
		</div>
		<!--end::Footer-->
	</div>
</div>
